<div class="col-md-12"><h3>Employees Table</h3></div>
<div class="col-md-12">
		...
		<?php if($company_id) {  ?>
				...
				<?php if(count($employees)) { ?>
						...
						<tr>
							...
							<td align="center"><a href="<?php echo base_url(); ?>employees/<?php echo $v->company_id .'/'. $v->id; ?>"><i class="glyphicon glyphicon-pencil"></i></a></td>
						</tr>
